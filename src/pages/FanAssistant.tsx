...
const UI_TRANSLATIONS: Record<string, {
  ...
  en: {
    ...
    fallbackText: "AI response not helpful? Connect directly with venue volunteers or support staff.",
  ...
  es: {
    ...
    disclaimer: "Pulse AI puede producir datos inexactos sobre el estadio. Verifique con el personal del lugar.",
    fallbackText: "¿La respuesta de la IA no es útil? Conéctese directamente con los voluntarios o el personal de soporte.",
    findVolunteer: "Buscar Voluntario",
    contactStaff: "Contactar Personal",
    alertVolunteer: "Conectándolo con un voluntario del estadio cercano. Verifique su servicio de ubicación.",
  ...
  fr: {
    ...
    disclaimer: "L'IA Pulse peut produire des données de stade inexactes. Vérifiez auprès du personnel.",
    fallbackText: "Réponse de l'IA non utile ? Contactez directement les bénévoles du stade ou le personnel d'assistance.",
    findVolunteer: "Trouver Bénévole",
    contactStaff: "Contacter Staff",
    alertVolunteer: "Connexion à un bénévole du stade à proximité. Vérifiez votre service de localisation.",
  ...
  hi: {
    ...
    disclaimer: "पल्स एआई गलत स्टेडियम डेटा उत्पन्न कर सकता है। आयोजन स्थल के कर्मचारियों से सत्यापित करें।",
    fallbackText: "एआई प्रतिक्रिया मददगार नहीं है? आयोजन स्थल के स्वयंसेवकों या सहायता कर्मचारियों से सीधे जुड़ें।",
    findVolunteer: "स्वयंसेवक खोजें",
    contactStaff: "कर्मचारियों से संपर्क करें",
    alertVolunteer: "आपको पास के स्टेडियम स्वयंसेवक से जोड़ा जा रहा है। अपनी स्थान सेवा की जाँच करें।",
    alertStaff: "आयोजन स्थल संचालन सहायता डेस्क को कॉल किया जा रहा है। लाइव एजेंट प्रतिक्रिया बैकअप सक्रिय है।"
  },
  ar: {
    ask: "اسأل",
    pulse: "بالس",
    ...
    disclaimer: "قد ينتج ذكاء بالس الاصطناعي بيانات غير دقيقة عن الملعب. يرجى التحقق مع موظفي الموقع.",
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-8rem)] max-w-3xl mx-auto px-4 md:px-0">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between mb-6 gap-4">
        <div>
          <h2 className="text-3xl md:text-4xl font-black tracking-tighter uppercase font-heading">{t.ask} <span className="text-[#ccff00]">{t.pulse}</span></h2>
          ...
          {chatHistory.map((msg) => (
            ...
            >
              <div className={cn(
                ...
                {msg.role === 'user' ? <User className="w-6 h-6" /> : <BrainCircuit className="w-6 h-6 text-[#ccff00]" />}
              </div>
              <div className={cn(
