      ...
      <div className="flex flex-col gap-6 overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto space-y-4 pr-2">
          ...
          {resolvedIncidents.length > 0 && (
            <>
              <div className="text-[10px] font-bold text-gray-500 uppercase tracking-widest px-2 pt-4">
                Recently Resolved
              </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center gap-6 text-sm text-gray-400">
                    <div className="flex items-center gap-2">
                      <MapPin className="w-4 h-4 text-[#ccff00]" /> {selected.zoneId}
                    </div>
                    <div className="flex items-center gap-2">
                      <Clock className="w-4 h-4" /> Detected{' '}
                      {selected.timestamp.split('T')[1].slice(0, 5)}
                    </div>
                    <div className="flex items-center gap-2">
              ...
              <div className="flex-1 grid md:grid-cols-[1fr_350px] overflow-hidden">
                <div className="p-8 overflow-y-auto space-y-8">
                  <section>
                    ...
                    <p className="text-lg leading-relaxed text-gray-300">{selected.description}</p>
                  </section>
                  ...
                  <section className="bg-black/20 rounded-3xl p-6 border border-white/5">
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      <h3 className="font-bold text-[#ccff00] uppercase tracking-tighter text-sm">
                        AI Response Plan
                      </h3>
                    </div>
                    <div className="space-y-4">
                      <div className="flex gap-3">
                        ...
                        <p className="text-sm text-gray-400">
                          Dispatch nearest volunteer (currently 40m away) to evaluate crowd
                          pressure.
                        </p>
                      </div>
                      <div className="flex gap-3">
                        ...
                        <p className="text-sm text-gray-400">
                          Update digital signage in South Concourse to divert flow to Gate C.
                        </p>
                      </div>
                      <div className="flex gap-3">
                        <div className="w-5 h-5 rounded-full bg-white/10 flex items-center justify-center text-[10px] font-bold shrink-0">
                        ...
                        <p className="text-sm text-gray-400">
                          Broadcast multilingual audio alert in Zone 4 (Spanish/English).
                        </p>
                      </div>
                    </div>
                  </section>
    ...
    >
      <div className="flex justify-between items-start mb-2">
        ...
        <span className="text-[10px] text-gray-600 font-bold">
          {incident.timestamp.split('T')[1].slice(0, 5)}
        </span>
      </div>
      <h4 className={cn('font-bold text-sm mb-1', active ? 'text-[#ccff00]' : 'text-white')}>
        {incident.title}
      </h4>
