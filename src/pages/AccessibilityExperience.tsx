    ...
    <div className="max-w-4xl mx-auto space-y-12 pb-20">
      ...
      <div className="space-y-4">
        ...
        <p className="text-gray-500 text-lg">
          PULSEPATH adapts to your sensory and mobility needs to ensure a safe, comfortable
          match-day.
        </p>
      </div>
        ...
        <section className="bg-white/5 border border-white/10 rounded-[2.5rem] p-8 space-y-8">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <div
                className="flex bg-black/40 p-1 rounded-xl border border-white/5"
                role="group"
      ...
      <div className="bg-red-500/10 border border-red-500/20 rounded-[2.5rem] p-10 flex flex-col items-center text-center space-y-6">
        ...
        <div>
          ...
          <p className="text-gray-400 max-w-md mx-auto mt-2">
            Clicking this button will alert the nearest Accessibility Steward and medical team to
            your exact location.
          </p>
        </div>
        <Button
          size="lg"
          className="bg-red-500 hover:bg-red-600 text-white rounded-2xl px-12 py-8 text-xl font-black uppercase tracking-tighter"
        >
          Call For Assistance
        </Button>
      </div>
...
function FacilityCard({ icon: Icon, title, desc, onClick }: any) {
  return (
    ...
    >
      ...
      <Button
        variant="link"
        className="p-0 h-auto text-blue-500 text-xs font-bold mt-4 uppercase tracking-widest"
      >
